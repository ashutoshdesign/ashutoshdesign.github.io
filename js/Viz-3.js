	...
	var svg61 = d3.select('.viz3').select('.viz32').select('.viz321')
		...
		.append('g')
		.attr('transform', 'translate(' + ((width + margin.left + margin.right)/4 + (width + margin.left + margin.right)/48) + ',' + margin.top/2 + ')');
...
//----------- Start of Viz 321------------------------------------- Start of Viz 321------------------------------------
	...
	function make_x_gridlines61() {		
	    return d3.axisBottom(xScale61).ticks(3)
	...
	svg61.selectAll(".point61")
	    ...
	    .attr('x', function(d){
	    	if(d.D1 >= 0) return 15;
	    	else return xScale61(d.D1)-7;
	    })
	    .attr('y', function(d){return yScale61(d.Device)+2.5})
	    .attr('height', yScale61.bandwidth()-5)
    	.attr('width', function(d){
    		if(d.D1 > 0) return xScale61(d.D1)-15;
    		else if(d.D1 == 0) return 1;
...
//----------- Start of Viz 322------------------------------------- Start of Viz 322------------------------------------
	...
	function make_x_gridlines62() {		
	    return d3.axisBottom(xScale62).ticks(3)
	...
	svg62.selectAll(".point62")
	    ...
	    .attr('x', function(d){
	    	if(d.D2 >= 0) return 15;
	    	else return xScale61(d.D2)-7;
	    })
	    .attr('y', function(d){return yScale61(d.Device)+2.5})
	    .attr('height', yScale62.bandwidth()-5)
    	.attr('width', function(d){
    		if(d.D2 > 0) return xScale61(d.D2)-15;
    		else if(d.D2 == 0) return 1;
			else return Math.abs(xScale61(d.D2));
    	});
...
//----------- Start of Viz 323------------------------------------- Start of Viz 323------------------------------------
	...
	function make_x_gridlines63() {		
	    return d3.axisBottom(xScale63).ticks(3)
	...
	svg63.selectAll(".point63")
    	...
    	.attr('width', function(d){
    		if(d.D3 > 0) return xScale63(d.D3)-15;
