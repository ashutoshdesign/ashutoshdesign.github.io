	...
	//----------- Start of Viz 11------------------------------------- Start of Viz 11------------------------------------
	  ...
	  svg1.append("g")			
		...
		svg1.selectAll(".point")
		    ...
		    .attr('id', function(d){return 'id' + d.NumberOfDoF + d.ProductType.substring(0,1) + d.DoFTypeIndex + d.Mechanism.substring(0,1);})
		...
		d3.csv("./csv/stacked.csv", function(d, i, columns) {
		  ...
		  return d;
			  ...
			  // adding color to bars according to degrees of freedom
	   		  d3.selectAll('.point2').data(data).attr('fill', function(d){return DoF(d.NumberOfDoF)});
